...
| Task | Description |
| :--- | :--- |
| **🔁 Restore Point** | Automatically creates a system restore point before running any tasks |
...
## 🔄 Re-Enable SysMain
<!-- DISPLAY_START -->
If you prefer to have SysMain running after the fix is complete, use this secondary script to restore default settings. A restore point is created automatically before making any changes.
<!-- DISPLAY_END -->
**Instructions:**
